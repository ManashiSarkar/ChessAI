...
function drop(ev) {
    ...
    */
    ...
    if (ev.target.tagName === 'IMG' && to_id && from_parent && from_id !== to_id && check(from_rules,from_piece,from_camp,from_id,ev.target.id) ) {
        //drop
...
function check(from_rules,from_piece,from_camp,from_id,to_id) {
