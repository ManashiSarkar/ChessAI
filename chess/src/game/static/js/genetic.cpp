...
////////////////////////// MODIFIABLE /////////////////////////////////////
// pieces and power
#define total_piece parameters[0]
#define total_power parameters[1]
#define piece_power parameters[2]

// freedom of movement and coverage
#define total_coverage parameters[3]
#define total_mobile parameters[4]
#define coverage_mobile parameters[5]

// attack and defense
#define attack_piece parameters[6]
#define attack_power parameters[7]
#define attack_piece_power parameters[8]

// positive weights on it's own
#define bishop_pair parameters[9]
#define knight_pair parameters[10]
#define rook_pair parameters[11]

#define pawn_chain parameters[12]
#define castled_king parameters[13]
#define kingsguard parameters[14]
#define gives_mate parameters[15]
#define kingsguard_pieces parameters[16]
...
void init()
{
	...
	for(auto u: vec) cout << u.ff << " " << u.ss << endl;
	sleep(4);
...
int main() 
{
	...
	forr(gen,1,generations+1)
	{
		...
		//forr(i,0,N/2)
		{
			...
			print("newgame",1,"generation",gen);
			sleep(T);
...
/*
	...
	outcome.outcome += g.total_piece * a + g.total_power * b + g.piece_power * a * b;
	...
	outcome.outcome += g.total_coverage * a;
